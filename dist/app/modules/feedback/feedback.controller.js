...
exports.feedbackControlles = void 0;
...
const createFeedback = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield feedback_service_1.feedbackServices.createfeedbackIntoDB(payload);
...
const getAllFeedback = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield feedback_service_1.feedbackServices.getFeedbackFromDB();
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
